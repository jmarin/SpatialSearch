 ...
 */
public class GeoDBTestDataSourceFactory implements FactoryBean<DataSource> {
	 ...
	 * @param schemaLocation the location of the file containing the schema DDL
	 *            to export to the database
	 * @param testDataLocation the location of the file containing the test data
	 *            to load into the database
	 */
	public GeoDBTestDataSourceFactory(String testDatabaseName, Resource schemaLocation, Resource testDataLocation) {
	...
	public static DataSource createDataSource(String testDatabaseName, Resource schemaLocation,
		...
		return new GeoDBTestDataSourceFactory(testDatabaseName, schemaLocation, testDataLocation).getDataSource();
	}
